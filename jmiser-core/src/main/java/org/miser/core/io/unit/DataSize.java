package org.miser.core.io.unit;
...
public final class DataSize implements Comparable<DataSize> {
	...
	/**
	 * Obtain a DataSize from a text string such as {@code 12MB} using the specified
	 * default {@link DataUnit} if no unit is specified.
	 * <p>
	 * The string starts with a number followed optionally by a unit matching one of
	 * the supported {@linkplain DataUnit suffixes}.
	 * <p>
	 * Examples:
	 * 
	 * <pre>
