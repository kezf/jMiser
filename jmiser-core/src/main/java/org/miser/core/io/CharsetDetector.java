...
public class CharsetDetector {
	...
	static {
		String[] names = { "UTF-8", "GBK", "GB2312", "GB18030", "UTF-16BE", "UTF-16LE", "UTF-16", "BIG5", "UNICODE",
				"US-ASCII" };
	 ...
	 * @return 编码
	 */
	protected static Charset detectCharset(InputStream in, Charset charset) throws IOException {
