...
/**
 * 借助{@link FastStringBuilder} 提供快读的字符串写出，相比jdk的StringWriter非线程安全，速度更快。
 *
 * @author Oliver
 * 
 */
public final class FastStringWriter extends Writer {
	...
	private final FastStringBuilder builder;

	/**
	 * 构造
	 */
	public FastStringWriter() {
		this(FastStringBuilder.DEFAULT_CAPACITY);
	}
	...
	public FastStringWriter(int initialSize) {
		if (initialSize < 0) {
			initialSize = FastStringBuilder.DEFAULT_CAPACITY;
		}
		this.builder = new FastStringBuilder(initialSize);
	}
