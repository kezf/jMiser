...
public class FileNameUtil {
	...
	public static String cleanInvalid(String fileName) {
		return StringUtil.isBlank(fileName) ? fileName : RegexUtil.delAll(FILE_NAME_INVALID_PATTERN_WIN, fileName);
	}
	...
	public static boolean containsInvalid(String fileName) {
		return (false == StringUtil.isBlank(fileName)) && RegexUtil.contains(FILE_NAME_INVALID_PATTERN_WIN, fileName);
	}
