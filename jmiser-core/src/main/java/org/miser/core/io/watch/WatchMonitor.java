...
import org.miser.core.io.watch.watchers.WatcherChain;
	...
	public void init() throws WatchException {
		...
		if (false == Files.exists(this.path, LinkOption.NOFOLLOW_LINKS)) {
			...
			if (null != lastPathEle) {
				...
				if (StringUtil.contains(lastPathEleStr, StringUtil.C_DOT)
						&& false == StringUtil.endWithIgnoreCase(lastPathEleStr, ".d")) {
