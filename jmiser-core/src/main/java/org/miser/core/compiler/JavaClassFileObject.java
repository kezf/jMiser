...
class JavaClassFileObject extends SimpleJavaFileObject {
	 ...
	 * @see JavaClassFileManager#getJavaFileForOutput(javax.tools.JavaFileManager.Location,
	...
	/**
	 * 获得字节码输入流 编译器编辑源码后，我们将通过此输出流获得编译后的字节码，以便运行时加载类
	 *
	 * @return 字节码输入流
	...
	/**
	 * 获得字节码输出流 编译器编辑源码时，会将编译结果输出到本输出流中
	 *
	 * @return 字节码输出流
	 */
	@Override
