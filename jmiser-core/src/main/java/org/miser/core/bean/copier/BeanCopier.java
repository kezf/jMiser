package org.miser.core.bean.copier;
...
import org.miser.core.bean.BeanException;
import org.miser.core.bean.BeanUtil;
import org.miser.core.bean.DynamicBean;
import org.miser.core.bean.copier.provider.BeanValueProvider;
import org.miser.core.bean.copier.provider.DynamicBeanValueProvider;
import org.miser.core.bean.copier.provider.MapValueProvider;
import org.miser.core.collection.CollUtil;
import org.miser.core.lang.copier.Copier;
...
public class BeanCopier<T> implements Copier<T>, Serializable {
	...
	public T copy() {
		if (null != this.source) {
			...
			} else if (this.source instanceof DynamicBean) {
				// 目标只支持Bean
				valueProviderToBean(new DynamicBeanValueProvider((DynamicBean) this.source, copyOptions.ignoreError),
						this.dest);
	...
	private void beanToBean(Object providerBean, Object destBean) {
		valueProviderToBean(
				new BeanValueProvider(providerBean, this.copyOptions.ignoreCase, this.copyOptions.ignoreError),
				destBean);
	}
