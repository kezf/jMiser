...
import org.miser.core.text.ASCIIStrCache;
import org.miser.core.text.CharPool;
...
public class CharUtil implements CharPool {
	 ...
	 * @return 转换后的字符
	 * @see <a href=
	 *      "https://en.wikipedia.org/wiki/List_of_Unicode_characters#Unicode_symbols">Unicode_symbols</a>
	 * @see <a href=
	 *      "https://en.wikipedia.org/wiki/Enclosed_Alphanumerics">Alphanumerics</a>
	 * 
	 */
	 ...
	 * @see <a href=
	 *      "https://baike.baidu.com/item/%E7%89%B9%E6%AE%8A%E5%AD%97%E7%AC%A6/112715?fr=aladdin">百度百科
	 *      特殊字符</a>
	 * 
	 */
