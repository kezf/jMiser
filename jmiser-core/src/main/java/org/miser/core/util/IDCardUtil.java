...
public class IDCardUtil {
	...
	public static String convert15To18(String idCard) {
		...
		if (RegexUtil.isMatch(PatternPool.NUMBERS, idCard)) {
			// 获取出生年月日
	...
	public static boolean isValidCard18(String idcard, boolean ignoreCase) {
		...
		if (RegexUtil.isMatch(PatternPool.NUMBERS, code17)) {
			// 获取校验位
	...
	public static class Idcard implements Serializable {
		...
		public String toString() {
			return "Idcard{" + "provinceCode='" + provinceCode + '\'' + ", cityCode='" + cityCode + '\''
