...
import org.miser.core.text.escape.Html4Escape;
import org.miser.core.text.escape.Html4Unescape;
import org.miser.core.text.escape.XmlEscape;
import org.miser.core.text.escape.XmlUnescape;
...
public class EscapeUtil {
	...
	private static final Filter<Character> JS_ESCAPE_FILTER = c -> false == (Character.isDigit(c)
			|| Character.isLowerCase(c) || Character.isUpperCase(c) || StringUtil.contains(NOT_ESCAPE_CHARS, c));
