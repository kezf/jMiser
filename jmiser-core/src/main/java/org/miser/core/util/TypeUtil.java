...
import org.miser.core.lang.ParameterizedTypeImpl;
import org.miser.core.lang.reflect.ActualTypeMapperPool;
...
public class TypeUtil {
	...
	/**
	 * 获得泛型变量对应的泛型实际类型，如果此变量没有对应的实际类型，返回null 此方法可以处理复杂的泛型化对象，类似于Map&lt;User,
	 * Key&lt;Long&gt;&gt;
	 *
	 * @param type              类
