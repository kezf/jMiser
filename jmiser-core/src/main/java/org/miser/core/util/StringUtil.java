...
import org.miser.core.text.CharSequenceUtil;
import org.miser.core.text.FastStringBuilder;
import org.miser.core.text.StringPool;
import org.miser.core.text.TextSimilarity;
...
public class StringUtil extends CharSequenceUtil implements StringPool {
	 ...
	 * </p>
	 * <ul>
	 * <li>{@code StringUtil.isBlankIfStr(null)     // true}</li>
	 * <li>{@code StringUtil.isBlankIfStr("")       // true}</li>
	 * <li>{@code StringUtil.isBlankIfStr(" \t\n")  // true}</li>
	 * <li>{@code StringUtil.isBlankIfStr("abc")    // false}</li>
	 * </ul>
	 *
	 * <p>
	 ...
	 * <li>{@code StringUtil.isEmptyIfStr(" \t\n")  // false}</li>
	 ...
	 */
	public static FastStringBuilder fastBuilder() {
		return FastStringBuilder.create();
	}
	 ...
	 * @return FastStringBuilder对象
	 */
	public static FastStringBuilder fastBuilder(int capacity) {
		return FastStringBuilder.create(capacity);
	}
