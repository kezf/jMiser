...
import org.miser.core.date.DateField;
import org.miser.core.date.DateTime;
import org.miser.core.date.DateUtil;
import org.miser.core.exceptions.UtilException;
import org.miser.core.lang.WeightRandom;
import org.miser.core.lang.WeightRandom.WeightObj;
...
public class RandomUtil {
	...
	/**
	 * 获取SHA1PRNG的{@link SecureRandom}，类提供加密的强随机数生成器 (RNG)<br>
	 * 注意：此方法获取的是伪随机序列发生器PRNG（pseudo-random number
	 * generator）,在Linux下噪声生成时可能造成较长时间停顿。<br>
