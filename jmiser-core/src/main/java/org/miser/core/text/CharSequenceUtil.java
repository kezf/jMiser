...
import org.miser.core.comparator.VersionComparator;
import org.miser.core.convert.Convert;
import org.miser.core.lang.Assert;
import org.miser.core.lang.Filter;
import org.miser.core.lang.Matcher;
import org.miser.core.lang.func.Func1;
import org.miser.core.util.ArrayUtil;
import org.miser.core.util.CharUtil;
import org.miser.core.util.CharsetUtil;
import org.miser.core.util.DesensitizedUtil;
import org.miser.core.util.NumberUtil;
...
public class CharSequenceUtil {
	 ...
	 *
	 * <p>
	 * 注意，和{@link String#trim()}不同，此方法使用{@link CharUtil#isBlankChar(char)} 来判定空白，
	...
	public static String[] splitToArray(CharSequence str, char separator, int limit) {
		...
		return StringSplitter.splitToArray(str.toString(), separator, limit, false, false);
	}
	...
	public static List<String> split(CharSequence str, char separator, int limit, boolean isTrim, boolean ignoreEmpty) {
		...
		return StringSplitter.split(str.toString(), separator, limit, isTrim, ignoreEmpty);
	}
	...
	public static List<String> split(CharSequence str, CharSequence separator, int limit, boolean isTrim,
		...
		return StringSplitter.split(str.toString(), separatorStr, limit, isTrim, ignoreEmpty);
	}
	 ...
	 * @param len 每一个小节的长度
	 * @return 截取后的字符串数组
	 * @see StringSplitter#splitByLength(String, int)
	 */
	public static String[] split(CharSequence str, int len) {
		if (null == str) {
			return new String[] {};
		}
		return StringSplitter.splitByLength(str.toString(), len);
	}
	 ...
	 *
	 * <pre>
	 * StringUtil.subBefore(null, *, false)      = null
	 * StringUtil.subBefore("", *, false)        = ""
	 * StringUtil.subBefore("abc", "a", false)   = ""
	 * StringUtil.subBefore("abcba", "b", false) = "a"
	 * StringUtil.subBefore("abc", "c", false)   = "ab"
	 * StringUtil.subBefore("abc", "d", false)   = "abc"
	 * StringUtil.subBefore("abc", "", false)    = ""
	 * StringUtil.subBefore("abc", null, false)  = "abc"
	 * </pre>
	 *
	 ...
	 *
	 * <pre>
	 * StringUtil.subAfter(null, *, false)      = null
	 * StringUtil.subAfter("", *, false)        = ""
	 * StringUtil.subAfter(*, null, false)      = ""
	 * StringUtil.subAfter("abc", "a", false)   = "bc"
	 * StringUtil.subAfter("abcba", "b", false) = "cba"
	 * StringUtil.subAfter("abc", "c", false)   = ""
	 * StringUtil.subAfter("abc", "d", false)   = ""
	 * StringUtil.subAfter("abc", "", false)    = "abc"
	 * </pre>
	 *
	 * @param string          被查找的字符串
	 * @param separator       分隔字符串（不包括）
	 ...
	 * StringUtil.subBetweenAll("", "")          			= []
	 * StringUtil.subBetweenAll("", "#")         			= []
	 * StringUtil.subBetweenAll("gotanks", "")     		= []
	 * StringUtil.subBetweenAll("#gotanks#", "#")   		= ["gotanks"]
	 * StringUtil.subBetweenAll("#hello# #world#!", "#")   = ["hello", "world"]
	 * StringUtil.subBetweenAll("#hello# world#!", "#");   = ["hello"]
	 * </pre>
	 *
	 * @param str             被切割的字符串
	...
	public static String repeatAndJoin(CharSequence str, int count, CharSequence conjunction) {
		...
		final FastStringBuilder builder = FastStringBuilder.create();
	 ...
	 * StringUtil.padPre("1039", -1, "0");//"103"
	 * </pre>
	 *
	 * @param str    字符串
	 * @param length 长度
	 ...
	 * StringUtil.padAfter("123", -1, '0')//"" 空串
	 * </pre>
	 *
	 ...
	 * @param version1 版本1
	 * @param version2 版本2
	 * @return 排序值。负数：version1 &lt; version2，正数：version1 &gt; version2, 0：version1
	 *         == version2
	 * 
	 */
	...
	public static String replace(CharSequence str, int fromIndex, CharSequence searchStr, CharSequence replacement,
		...
		final FastStringBuilder result = FastStringBuilder.create(strLength + 16);
		if (0 != fromIndex) {
	 ...
	 * @return 替换后的字符串
	 * @see RegexUtil#replaceAll(CharSequence, java.util.regex.Pattern, Func1)
	 * 
	 */
	 ...
	 * @param replaceFun 决定如何替换的函数
	 * @return 替换后的字符串
	 * @see RegexUtil#replaceAll(CharSequence, String, Func1)
	 * 
	 */
	 ...
	 *
	 * <pre>
	 * StringUtil.hide(null,*,*)=null
	 * StringUtil.hide("",0,*)=""
	 * StringUtil.hide("jackduan@163.com",-1,4)   ****duan@163.com
	 * StringUtil.hide("jackduan@163.com",2,3)    ja*kduan@163.com
	 * StringUtil.hide("jackduan@163.com",3,2)    jackduan@163.com
	 * StringUtil.hide("jackduan@163.com",16,16)  jackduan@163.com
	 * StringUtil.hide("jackduan@163.com",16,17)  jackduan@163.com
	 * </pre>
	 *
	 * @param str          字符串
	 * @param startInclude 开始位置（包含）
	 ...
	 *
	 * <pre>
	 * StringUtil.desensitized("100", DesensitizedUtils.DesensitizedType.USER_ID)) =  "0"
	 * StringUtil.desensitized("段正淳", DesensitizedUtils.DesensitizedType.CHINESE_NAME)) = "段**"
	 * StringUtil.desensitized("51343620000320711X", DesensitizedUtils.DesensitizedType.ID_CARD)) = "5***************1X"
	 * StringUtil.desensitized("09157518479", DesensitizedUtils.DesensitizedType.FIXED_PHONE)) = "0915*****79"
	 * StringUtil.desensitized("18049531999", DesensitizedUtils.DesensitizedType.MOBILE_PHONE)) = "180****1999"
	 * StringUtil.desensitized("北京市海淀区马连洼街道289号", DesensitizedUtils.DesensitizedType.ADDRESS)) = "北京市海淀区马********"
	 * StringUtil.desensitized("duandazhi-jack@gmail.com.cn", DesensitizedUtils.DesensitizedType.EMAIL)) = "d*************@gmail.com.cn"
	 * StringUtil.desensitized("1234567890", DesensitizedUtils.DesensitizedType.PASSWORD)) = "**********"
	 * StringUtil.desensitized("苏D40000", DesensitizedUtils.DesensitizedType.CAR_LICENSE)) = "苏D4***0"
	 * StringUtil.desensitized("11011111222233333256", DesensitizedType.BANK_CARD)) = "1101 **** **** **** 3256"
	 * </pre>
	 *
	 * @param str              字符串
	...
	public static String toSymbolCase(CharSequence str, char symbol) {
		...
		final int length = str.length();
		final FastStringBuilder sb = new FastStringBuilder();
		char c;
		for (int i = 0; i < length; i++) {
			c = str.charAt(i);
			...
			if (Character.isUpperCase(c)) {
				...
				if (symbol != c && sb.length() > 0 && Character.isUpperCase(sb.charAt(-1))
	...
	/**
	 * 创建FastStringBuilder对象
	 *
	 * @param strs 初始字符串列表
	 * @return FastStringBuilder对象
	 */
	public static FastStringBuilder fastBuilder(CharSequence... strs) {
		return FastStringBuilder.create(strs);
	}
	...
	public static String move(CharSequence str, int startInclude, int endExclude, int moveLength) {
		...
		final FastStringBuilder fastBuilder = FastStringBuilder.create(len);
		if (moveLength > 0) {
			int endAfterMove = Math.min(endExclude + moveLength, str.length());
			fastBuilder.append(str.subSequence(0, startInclude))//
			...
			fastBuilder.append(str.subSequence(0, startAfterMove))//
					.append(str.subSequence(startInclude, endExclude))//
