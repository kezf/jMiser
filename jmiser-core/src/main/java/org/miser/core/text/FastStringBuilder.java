 ...
 * @author Oliver
 */
public class FastStringBuilder implements CharSequence, Appendable, Serializable {
	 ...
	 * @return this
	 */
	public static FastStringBuilder create() {
	 ...
	 * @return this
	 */
	public static FastStringBuilder create(int initialCapacity) {
		return new FastStringBuilder(initialCapacity);
	}
	 ...
	 * 
	 */
	public static FastStringBuilder create(CharSequence... strs) {
		return new FastStringBuilder(strs);
	}
	 ...
	 * @param strs 初始字符串
	 */
	public FastStringBuilder(CharSequence... strs) {
	 ...
	 * @return this
	 */
	public FastStringBuilder append(char[] src) {
	 ...
	 * @return this
	 */
	public FastStringBuilder append(char[] src, int srcPos, int length) {
	 ...
	 * @return this
	 */
	public FastStringBuilder insert(int index, char[] src) {
		if (ArrayUtil.isEmpty(src)) {
			return this;
		}
	 ...
	 * @return this
	 */
	public FastStringBuilder insert(int index, char[] src, int srcPos, int length) {
	 ...
	 * @return this
	 */
	public FastStringBuilder insert(int index, CharSequence csq) {
		if (null == csq) {
		...
		} else if (csq instanceof FastStringBuilder) {
			((FastStringBuilder) csq).getChars(0, len, this.value, index);
	 ...
	 * @return this
	 */
	public FastStringBuilder insert(int index, CharSequence csq, int start, int end) {
		if (csq == null) {
			csq = "null";
		}
	 ...
	 * @return this
	 */
	public FastStringBuilder getChars(int srcBegin, int srcEnd, char[] dst, int dstBegin) {
		if (srcBegin < 0) {
			srcBegin = 0;
		}
		if (srcEnd < 0) {
	 ...
	 * @return this
	 */
	public FastStringBuilder delTo(int newPosition) {
		if (newPosition < 0) {
			newPosition = 0;
		}
	 ...
	 */
	public FastStringBuilder del(int start, int end) throws StringIndexOutOfBoundsException {
		if (start < 0) {
			start = 0;
		}
