 ...
 *
 * <p>
 * 也可以使用{@link #reflectionCompare(Object, Object) reflectionCompare}
 * 方法通过反射比较字段，使用方法如下：
 *
 * <pre>
 * public int compareTo(Object o) {
...
public class CompareToBuilder implements Builder<Integer> {
     ...
     *
     * <p>
     * Fields can be private, thus <code>AccessibleObject.setAccessible</code> is
     ...
     *
     * <p>
     * If both <code>lhs</code> and <code>rhs</code> are <code>null</code>, they are
     * considered equal.
     * </p>
     *
     ...
     *                              with <code>lhs</code>
     * 
     *                              <code>reflectionCompare(Object, Object, boolean, Class)</code>)
     */
    public static int reflectionCompare(final Object lhs, final Object rhs, final boolean compareTransients,
    ...
    private static void reflectionAppend(final Object lhs, final Object rhs, final Class<?> clazz,
            final CompareToBuilder builder, final boolean useTransients, final String[] excludeFields) {

        final Field[] fields = clazz.getDeclaredFields();
        AccessibleObject.setAccessible(fields, true);
        for (int i = 0; i < fields.length && builder.comparison == 0; i++) {
            final Field f = fields[i];
            if (false == ArrayUtil.contains(excludeFields, f.getName()) && (f.getName().indexOf('$') == -1)
    ...
    /**
     * <p>
     * Appends to the <code>builder</code> the <code>compareTo(Object)</code> result
     * of the superclass.
     * </p>
     *
     ...
     * <code>null</code>, a <code>null</code> object is less than a
     * non-<code>null</code> object</li>
     ...
     * <code>comparator</code> is <code>null</code>, <code>lhs</code> must implement
     * {@link Comparable} instead.
     * </p>
     *
     * @param lhs        left-hand object
     * @param rhs        right-hand object
     * @param comparator <code>Comparator</code> used to compare the objects,
     *                   <code>null</code> means treat lhs as
     ...
     *                   elements, <code>null</code> means to treat <code>lhs</code>
     *                   elements as <code>Comparable</code>.
     * @return this - used to chain append calls
     * @throws ClassCastException if <code>rhs</code> is not assignment-compatible
     *                            with <code>lhs</code>
     * 
     ...
     * <li>Check if for <code>null</code>, <code>null</code> is less than
     * non-<code>null</code></li>
     * <li>Check array length, a shorter length array is less than a longer length
     * array</li>
     * <li>Check array contents element by element using
     ...
     * <code>builder</code> has judged the "left-hand" side as less than, greater
