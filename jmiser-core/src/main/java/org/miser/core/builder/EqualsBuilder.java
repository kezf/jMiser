...
import org.miser.core.lang.Pair;
...
public class EqualsBuilder implements Builder<Boolean> {
	 ...
	 * swapped therefore a check is needed if the object pair is registered in given
	 * or swapped order.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * This method uses reflection to determine if the two <code>Object</code>s are
	 * equal.
	 * </p>
	 *
	 * <p>
	 ...
	 * as efficient as testing explicitly. Non-primitive fields are compared using
	 * <code>equals()</code>.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Static fields will not be included. Superclass fields will be appended up to
