package org.miser.core.builder;
...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    /**
     * <p>
     * A registry of objects used by reflection methods to detect cyclical object
    ...
    /*
     * NOTE: we cannot store the actual objects in a HashSet, as that would use the
     * very hashCode() we are in the process of calculating.
     *
     * So we generate a one-to-one mapping from the original object to a new object.
     *
     * Now HashSet uses equals() to determine if two elements with the same hashcode
     * really are equal, so we also need to ensure that the replacement objects are
     * only equal if the original objects are identical.
     *
    ...
    /**
     * <p>
     * Returns the registry of objects being traversed by the reflection methods in
     * the current thread.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns <code>true</code> if the registry contains the given object. Used by
     * the reflection methods to avoid infinite loops.
     * </p>
     *
     ...
     * @param excludeFields Collection of String field names to exclude from use in
    ...
    private static void reflectionAppend(final Object object, final Class<?> clazz, final HashCodeBuilder builder,
        ...
        try {
            ...
            for (final Field field : fields) {
                if (false == ArrayUtil.contains(excludeFields, field.getName()) && (field.getName().indexOf('$') == -1)
     ...
     *
     * <p>
     * It uses <code>AccessibleObject.setAccessible</code> to gain access to private
     * fields. This means that it will throw a security exception if run under a
     * security manager, if the permissions are not set up correctly. It is also not
     * as efficient as testing explicitly.
     * </p>
     *
     * <p>
     * Transient members will be not be used, as they are likely derived fields, and
     * not part of the value of the <code>Object</code>.
     * </p>
     *
     * <p>
     ...
     * should be different for each class, however this is not vital. Prime numbers
     * are preferred, especially for the multiplier.
     * </p>
     *
     * @param initialNonZeroOddNumber    a non-zero, odd number used as the initial
     *                                   value. This will be the returned value if
     *                                   no fields are found to include in the hash
     *                                   code
     * @param multiplierNonZeroOddNumber a non-zero, odd number used as the
     *                                   multiplier
     * @param object                     the Object to create a
     *                                   <code>hashCode</code> for
     ...
     *
     * <p>
     * Static fields will not be included. Superclass fields will be included up to
     * and including the specified superclass. A null superclass is treated as
     * java.lang.Object.
     * </p>
     *
     * <p>
     ...
     * @param excludeFields              array of field names to exclude from use in
     *                                   calculation of hash code
     * @return int hash code
     * @throws IllegalArgumentException if the Object is <code>null</code>
     * @throws IllegalArgumentException if the number is zero or even
     ...
     *
     * <p>
     * Static fields will not be tested. Superclass fields will be included. If no
     * fields are found to include in the hash code, the result of this method will
     * be constant.
     * </p>
     *
     ...
     *
     * @param object        the Object to create a <code>hashCode</code> for
     * @param excludeFields array of field names to exclude from use in calculation
     *                      of hash code
     * @return int hash code
     * @throws IllegalArgumentException if the object is <code>null</code>
     */
    ...
    /**
     * <p>
     * Registers the given object. Used by the reflection methods to avoid infinite
     * loops.
     * </p>
     *
    ...
    /**
     * <p>
     * Two randomly chosen, odd numbers must be passed in. Ideally these should be
     ...
     * </p>
     * <p>
     * This is in contrast to the standard <code>java.lang.Boolean.hashCode</code>
     * handling, which computes a <code>hashCode</code> value of <code>1231</code>
     * for <code>java.lang.Boolean</code> instances that represent <code>true</code>
     ...
     * likelihood of bugs in mis-calling toHashCode() and the unlikeliness of it
