package org.miser.core.net.url;
...
public final class UrlBuilder implements Serializable {
	 ...
	 * @return UrlBuilder
	 */
	public static UrlBuilder of(String scheme, String host, int port, String path, String query, String fragment,
			Charset charset) {
	 ...
	 * @return UrlBuilder
	 */
	public static UrlBuilder of(String scheme, String host, int port, UrlPath path, UrlQuery query, String fragment,
			Charset charset) {
	 ...
	 * @param charset  编码，用于URLEncode和URLDecode
	 */
	public UrlBuilder(String scheme, String host, int port, UrlPath path, UrlQuery query, String fragment,
			Charset charset) {
