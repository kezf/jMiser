package org.miser.core.date.format;
...
public class FastDateParser extends AbstractDateBasic implements DateParser {
	...
	// alternatives should be ordered longer first, and shorter last. ('february'
	// before 'feb')
	 ...
	 * </p>
	 * <p>
	 * Use {@link FastDateFormat#getInstance(String, TimeZone, Locale)} or another
	 * variation of the factory methods of {@link FastDateFormat} to get a cached
	...
	private static class ISO8601TimeZoneStrategy extends PatternStrategy {
		 ...
		 *
		 * @param tokenLen a token indicating the length of the TimeZone String to be
		 *                 formatted.
		 * @return a ISO8601TimeZoneStrategy that can format TimeZone String of length
		 *         {@code tokenLen}. If no such strategy exists, an
