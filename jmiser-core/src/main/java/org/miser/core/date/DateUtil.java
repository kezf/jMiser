...
import org.miser.core.date.format.DateParser;
import org.miser.core.date.format.DatePrinter;
import org.miser.core.date.format.FastDateFormat;
import org.miser.core.date.format.GlobalCustomFormat;
...
public class DateUtil extends CalendarUtil {
	...
	public static DateTime parseUTC(String utcString) {
		...
		if (StringUtil.contains(utcString, 'Z')) {
			...
			} else if (StringUtil.contains(utcString, CharUtil.DOT)) {
	...
	public static DateTime parse(CharSequence dateCharSequence) {
		...
		} else if (RegexUtil.isMatch(PatternPool.TIME, dateStr)) {
