...
public class LocalDateTimeUtil {
	...
	public static LocalDateTime of(TemporalAccessor temporalAccessor) {
		...
		return LocalDateTime.of(TemporalAccessorUtil.get(temporalAccessor, ChronoField.YEAR),
	...
	public static LocalDate ofDate(TemporalAccessor temporalAccessor) {
		...
		return LocalDate.of(TemporalAccessorUtil.get(temporalAccessor, ChronoField.YEAR),
				TemporalAccessorUtil.get(temporalAccessor, ChronoField.MONTH_OF_YEAR),
				TemporalAccessorUtil.get(temporalAccessor, ChronoField.DAY_OF_MONTH));
	}
		...
		if (StringUtil.isNotBlank(format)) {
			...
			if (StringUtil.startWithIgnoreEquals(format, DatePattern.PURE_DATETIME_PATTERN)) {
				...
				if (RegexUtil.isMatch("[S]{1,2}", fraction)) {
					...
					text = text + StringUtil.repeat('0', 3 - fraction.length());
				}
