...
public class LunarInfo {
	...
	/**
	 * 此表来自：https://github.com/jjonline/calendar.js/blob/master/calendar.js 农历表示： 1.
	 * 表示当年有无闰年，有的话，为闰月的月份，没有的话，为0。 2-4.为除了闰月外的正常月份是大月还是小月，1为30天，0为29天。 5.
	 * 表示闰月是大月还是小月，仅当存在闰月的情况下有意义。
	 */
	private static final long[] LUNAR_CODE = new long[] { 0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554,
			0x056a0, 0x09ad0, 0x055d2, // 1900-1909
