...
import org.miser.core.convert.NumberChineseFormatter;
import org.miser.core.date.chinese.ChineseMonth;
import org.miser.core.date.chinese.GanZhi;
import org.miser.core.date.chinese.LunarFestival;
import org.miser.core.date.chinese.LunarInfo;
import org.miser.core.date.chinese.SolarTerms;
...
public class ChineseDate {
	...
	private String cyclicalm(int year, int month, int day) {
		return StringUtil.format("{}年{}月{}日", GanZhi.getGanzhiOfYear(this.year),
				GanZhi.getGanzhiOfMonth(year, month, day), GanZhi.getGanzhiOfDay(year, month, day));
	}
