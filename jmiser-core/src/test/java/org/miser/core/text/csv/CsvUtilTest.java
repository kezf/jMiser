...
public class CsvUtilTest {
	...
	public void readTest3() {
		CsvReader reader = CsvUtil.getReader();
		reader.read(FileUtil.getUtf8Reader("test/test.csv"), Console::log);
	}

	@Test
	@Ignore
	public void writeTest() {
		CsvWriter writer = CsvUtil.getWriter("test/testWrite.csv", CharsetUtil.CHARSET_UTF_8);
		writer.write(new String[] { "a1", "b1", "c1", "123345346456745756756785656" },
				new String[] { "a2", "b2", "c2" }, new String[] { "a3", "b3", "c3" });
	}
	...
	public void writeBeansTest() {
		...
		CsvWriter writer = CsvUtil.getWriter("test/testWriteBeans.csv", CharsetUtil.CHARSET_UTF_8);
	...
	public void readLfTest() {
		...
		final CsvData read = reader.read(FileUtil.file("test/rw_test.csv"));
		for (CsvRow row : read) {
			Console.log(row);
		}
	}
	...
	public void writeWrapTest() {
		...
		final CsvWriter writer = CsvUtil.getWriter("test/csvWrapTest.csv", CharsetUtil.CHARSET_UTF_8);
