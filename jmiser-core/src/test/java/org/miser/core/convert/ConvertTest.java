...
import org.miser.core.date.DateException;
...
public class ConvertTest {
	...
	public void toClassTest() {
		final Class<?> convert = Convert.convert(Class.class, "org.miser.core.convert.ConvertTest.Product");
	...
	public enum BuildingType {
		PING(1, "平层"), CUO(2, "错层"), YUE(3, "跃层"), FUSHI(4, "复式"), KAIJIAN(5, "开间"), OTHER(6, "其他");
