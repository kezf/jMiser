...
public class ClassUtilTest {
	...
	public void getClassNameTest() {
		...
		Assert.assertEquals("org.miser.core.util.ClassUtil", className);
	...
	public void getShortClassNameTest() {
		String className = "org.miser.core.util.StringUtil";
		String result = ClassUtil.getShortClassName(className);
		Assert.assertEquals("o.m.c.u.StringUtil", result);
	}

	@Test
	public void getLocationPathTest() {
		final String classDir = ClassUtil.getLocationPath(ClassUtilTest.class);
		Assert.assertTrue(Objects.requireNonNull(classDir).endsWith("/jmiser-core/target/test-classes/"));
	}
}
