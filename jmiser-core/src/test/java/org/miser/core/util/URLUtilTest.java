...
public class URLUtilTest {
	...
	public void normalizeTest() {
		String url = "http://www.baidu.com//aaa/bbb";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.baidu.com//aaa/bbb", normalize);

		url = "www.baidu.com//aaa/bbb";
	...
	public void normalizeTest2() {
		String url = "http://www.baidu.com//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.baidu.com//aaa//bbb?a=1&b=2", normalize);

		url = "www.baidu.com//aaa/bbb?a=1&b=2";
		normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.baidu.com//aaa/bbb?a=1&b=2", normalize);
	}
	...
	public void formatTest() {
		String url = "//www.baidu.com//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.baidu.com//aaa//bbb?a=1&b=2", normalize);
	}
	...
	public void getHostTest() throws MalformedURLException {
		String url = "https://www.baidu.com//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		URI host = URLUtil.getHost(new URL(normalize));
		Assert.assertEquals("https://www.baidu.com", host.toString());
	}
	...
	public void getPathTest() {
		String url = " http://www.baidu.com/search?scope=ccc&q=ddd";
