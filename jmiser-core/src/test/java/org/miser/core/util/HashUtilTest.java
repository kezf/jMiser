...
public class HashUtilTest {
	...
	public void cityHash128Test() {
		...
		final long[] hash = HashUtil.cityHash128(StringUtil.utf8Bytes(s));
	...
	public void cityHash64Test() {
		String s = "Google发布的Hash计算算法：CityHash64 与 CityHash128";
		final long hash = HashUtil.cityHash64(StringUtil.utf8Bytes(s));
	...
	public void cityHash32Test() {
		String s = "Google发布的Hash计算算法：CityHash64 与 CityHash128";
		final int hash = HashUtil.cityHash32(StringUtil.utf8Bytes(s));
