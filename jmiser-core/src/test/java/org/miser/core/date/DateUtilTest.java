...
import org.miser.core.date.BetweenFormatter.Level;
import org.miser.core.date.format.FastDateFormat;
...
public class DateUtilTest {
	...
	public void parseCSTTest2() {
		...
		FastDateFormat fdf = FastDateFormat.getInstance(DatePattern.JDK_DATETIME_PATTERN,
	...
	public void endOfQuarterTest() {
		Date date = DateUtil.endOfQuarter(DateUtil.parse("2020-05-31 00:00:00"));
	...
	public void yearAndQTest() {
		...
		LinkedHashSet<String> yearAndQuarters = DateUtil.yearAndQuarter(DateUtil.parse("2018-09-10"),
				DateUtil.parse("2018-12-20"));
		...
		LinkedHashSet<String> yearAndQuarters2 = DateUtil.yearAndQuarter(DateUtil.parse("2018-10-10"),
				DateUtil.parse("2018-12-10"));
	...
	public void dateTest() {
		...
		Assert.assertEquals("2017-05-06", DateUtil.format(date2, DatePattern.NORM_DATE_PATTERN));
	}
	...
	public void betweenDayTest() {
		for (int i = 0; i < 1000; i++) {
			...
			long betweenDay = DateUtil.betweenDay(DateUtil.parseDate("1970-01-01"), DateUtil.parseDate(datr), false);
