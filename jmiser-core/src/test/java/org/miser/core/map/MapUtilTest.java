...
public class MapUtilTest {
	...
	public void filterContainsTest() {
		...
		Map<String, String> map2 = MapUtil.filter(map, t -> StringUtil.contains(t.getKey(), "bc"));
		Assert.assertEquals(2, map2.size());
	...
	public void sortJoinTest() {
		Map<String, String> build = MapUtil.builder(new HashMap<String, String>()).put("key1", "value1")
				.put("key3", "value3").put("key2", "value2").build();
