package org.miser.extra.compress.archiver;
...
import org.miser.extra.compress.CompressException;
...
public class StreamArchiver implements Archiver {
	...
	private void addInternal(File file, String path, Filter<File> filter) throws IOException {
		...
		final String entryName = StringUtil.addSuffixIfNot(StringUtil.nullToEmpty(path), StringUtil.SLASH) + file.getName();
