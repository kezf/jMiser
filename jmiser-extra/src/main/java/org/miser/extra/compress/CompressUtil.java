...
import org.miser.extra.compress.archiver.Archiver;
import org.miser.extra.compress.archiver.SevenZArchiver;
import org.miser.extra.compress.archiver.StreamArchiver;
import org.miser.extra.compress.extractor.Extractor;
import org.miser.extra.compress.extractor.SenvenZExtractor;
import org.miser.extra.compress.extractor.StreamExtractor;
...
public class CompressUtil {
	...
	public CompressorInputStream getIn(String compressorName, InputStream in) {
		...
		try {
			if(StringUtil.isBlank(compressorName)){
