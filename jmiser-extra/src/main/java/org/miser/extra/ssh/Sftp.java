...
import org.miser.extra.ftp.AbstractFtp;
import org.miser.extra.ftp.FtpConfig;
import org.miser.extra.ftp.FtpException;
...
public class Sftp extends AbstractFtp {
	...
	public Sftp reconnectIfTimeout() {
		if (StringUtil.isBlank(this.ftpConfig.getHost())) {
