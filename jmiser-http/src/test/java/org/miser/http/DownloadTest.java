...
import org.miser.core.io.StreamProgress;
...
public class DownloadTest {
	...
	public void downloadTest() {
		// 带进度显示的文件下载
		HttpUtil.downloadFile("http://mirrors.sohu.com/centos/7/isos/x86_64/CentOS-7-x86_64-DVD-1810.iso",
				FileUtil.file("d:/"), new StreamProgress() {
					...
					public void progress(long progressSize) {
						...
						Console.log("已下载：{}, 速度：{}/s", FileUtil.readableFileSize(progressSize),
	...
	public void downloadFileFromUrlTest1() {
		File file = HttpUtil.downloadFileFromUrl("http://groovy-lang.org/changelogs/changelog-3.0.5.html",
				"d:/download/temp");
	...
	public void downloadFileFromUrlTest2() {
		File file = null;
		try {
			file = HttpUtil.downloadFileFromUrl(
					"https://repo1.maven.org/maven2/org/miser/jmiser-all/5.4.0/jmiser-all-5.4.0-sources.jar",
					FileUtil.file("d:/download/temp"), 1, new StreamProgress() {
						@Override
						public void start() {
	...
	public void downloadFileFromUrlTest3() {
		...
		try {
			file = HttpUtil.downloadFileFromUrl(
					"https://repo1.maven.org/maven2/org/miser/jmiser-all/5.4.0/jmiser-all-5.4.0-sources.jar",
					FileUtil.file("d:/download/temp"), new StreamProgress() {
						@Override
						public void start() {
							System.out.println("start");
						}
	...
	public void downloadFileFromUrlTest4() {
		File file = null;
		try {
			file = HttpUtil.downloadFileFromUrl("http://groovy-lang.org/changelogs/changelog-3.0.5.html",
					FileUtil.file("d:/download/temp"), 1);
	...
	public void downloadFileFromUrlTest5() {
		...
		try {
			file = HttpUtil.downloadFileFromUrl("http://groovy-lang.org/changelogs/changelog-3.0.5.html",
					FileUtil.file("d:/download/temp", UUID.randomUUID().toString()));
		...
		File file1 = null;
		try {
			file1 = HttpUtil.downloadFileFromUrl("http://groovy-lang.org/changelogs/changelog-3.0.5.html",
					FileUtil.file("d:/download/temp"));
