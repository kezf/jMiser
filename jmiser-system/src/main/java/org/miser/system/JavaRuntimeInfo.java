...
public class JavaRuntimeInfo implements Serializable{
	...
	public final String[] getClassPathArray() {
		return StringUtil.splitToArray(getClassPath(), SystemUtil.get("path.separator", false));
	}
	...
	public final String[] getLibraryPathArray() {
		return StringUtil.splitToArray(getLibraryPath(), SystemUtil.get("path.separator", false));
	}
