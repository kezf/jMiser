...
import org.miser.core.img.GraphicsUtil;
import org.miser.core.img.ImgUtil;
...
public class ShearCaptcha extends AbstractCaptcha {
	...
	public Image createImage(String code) {
		...
		// 画干扰线
		drawInterfere(g, 0, RandomUtil.randomInt(this.height) + 1, this.width, RandomUtil.randomInt(this.height) + 1,
				this.interfereCount, ImgUtil.randomColor());
