...
import org.miser.crypto.symmetric.SymmetricAlgorithm;
import org.miser.crypto.symmetric.SymmetricCrypto;
import org.miser.crypto.symmetric.Vigenere;
...
public class SymmetricTest {
	...
	public void aesTest4() {
		...
		Assert.assertEquals(
				"cd0e3a249eaf0ed80c330338508898c4bddcfd665a1b414622164a273ca5daf7b4ebd2c00aaa66b84dd0a237708dac8e",
				encryptHex);
	}
	...
	public void aesZeroPaddingTest2() {
		...
		Assert.assertEquals(content, StringUtil.utf8Str(contentStream.toByteArray()));
	}

	@Test
	public void aesPkcs7PaddingTest() {
		String content = RandomUtil.randomString(RandomUtil.randomInt(200));
		AES aes = new AES("CBC", "PKCS7Padding", "0123456789ABHAEQ".getBytes(), "DYgjCEIMVrj2W9xN".getBytes());
