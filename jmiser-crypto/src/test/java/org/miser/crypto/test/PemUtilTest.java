...
public class PemUtilTest {
	...
	public void readECPrivateKeyTest2() {
		...
		byte[] sign = sm2.sign(StringUtil.utf8Bytes(content));
		boolean verify = sm2.verify(StringUtil.utf8Bytes(content), sign);
