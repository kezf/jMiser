...
import org.miser.crypto.asymmetric.AsymmetricAlgorithm;
import org.miser.crypto.asymmetric.RSA;
import org.miser.crypto.asymmetric.Sign;
import org.miser.crypto.asymmetric.SignAlgorithm;
import org.miser.crypto.digest.DigestAlgorithm;
import org.miser.crypto.digest.Digester;
import org.miser.crypto.digest.HMac;
import org.miser.crypto.digest.HmacAlgorithm;
import org.miser.crypto.digest.MD5;
import org.miser.crypto.symmetric.AES;
import org.miser.crypto.symmetric.DES;
import org.miser.crypto.symmetric.DESede;
import org.miser.crypto.symmetric.PBKDF2;
import org.miser.crypto.symmetric.RC4;
import org.miser.crypto.symmetric.SymmetricCrypto;
...
public class SecureUtil {
	 ...
	 *
	 * @param in       {@link InputStream} 如果想从文件读取.keystore文件，使用
	 ...
	 * see: http://snowolf.iteye.com/blog/391931
	 *
	 * @param in       {@link InputStream} 如果想从文件读取.cer文件，使用
	 *                 {@link FileUtil#getInputStream(java.io.File)} 读取
	 * @param password 密码
	 * @param alias    别名
	 * @return {@link KeyStore}
	...
	public static HMac hmacSha256(String key) {
		return hmacSha256(StringUtil.utf8Bytes(key));
	}
	...
	public static String signParams(DigestAlgorithm digestAlgorithm, Map<?, ?> params, String separator,
		...
		return new Digester(digestAlgorithm)
				.digestHex(MapUtil.sortJoin(params, separator, keyValueSeparator, isIgnoreNull, otherParams));
	}
