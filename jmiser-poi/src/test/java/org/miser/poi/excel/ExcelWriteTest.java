...
import org.miser.poi.excel.style.StyleUtil;
...
//		row2.put("age", 233);
	...
	public void writeBeanTest() {
		org.miser.poi.excel.TestBean bean1 = new org.miser.poi.excel.TestBean();
		bean1.setName("张三");
		bean1.setAge(22);
		bean1.setPass(true);
		...
		org.miser.poi.excel.TestBean bean2 = new org.miser.poi.excel.TestBean();
		bean2.setName("李四");
		bean2.setAge(28);
		bean2.setPass(false);
		...
		List<org.miser.poi.excel.TestBean> rows = CollUtil.newArrayList(bean1, bean2);
		// 通过工具类创建writer
	...
	public void writeBeanTest2() {
		org.miser.poi.excel.OrderExcel order1 = new org.miser.poi.excel.OrderExcel();
		order1.setId("1");
		order1.setNum("123");
		order1.setBody("body1");

		org.miser.poi.excel.OrderExcel order2 = new org.miser.poi.excel.OrderExcel();
		order1.setId("2");
		order1.setNum("456");
		order1.setBody("body2");

		List<org.miser.poi.excel.OrderExcel> rows = CollUtil.newArrayList(order1, order2);
		// 通过工具类创建writer
