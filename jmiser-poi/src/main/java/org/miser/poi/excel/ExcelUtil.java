...
import org.miser.core.exceptions.DependencyException;
...
import org.miser.poi.PoiChecker;
import org.miser.poi.excel.cell.CellLocation;
import org.miser.poi.excel.sax.ExcelSaxReader;
import org.miser.poi.excel.sax.ExcelSaxUtil;
...
public class ExcelUtil {
	...
	public static CellLocation toLocation(String locationRef) {
		...
		final int y = RegexUtil.getFirstNumber(locationRef) - 1;
