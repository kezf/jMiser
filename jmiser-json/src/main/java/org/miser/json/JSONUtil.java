...
import org.miser.json.serialize.JSONArraySerializer;
import org.miser.json.serialize.JSONDeserializer;
...
public class JSONUtil {
	...
	public static <T> T getByPath(JSON json, String expression, T defaultValue) {
		if((null == json || StringUtil.isBlank(expression))){
			return defaultValue;
		}
	...
	public static boolean isJsonObj(String str) {
		...
		return StringUtil.isWrap(StringUtil.trim(str), '{', '}');
	}
